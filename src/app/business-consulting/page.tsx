...
const BusinessConsultingHero: React.FC = () => {
  return (
...
const CLevelServicesSection: React.FC = () => {
  return (
...
const ServiceTagsSection: React.FC = () => {
  const services = [
...
const BusinessLeadersSection: React.FC = () => {
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
...
const VoiceOfClientsSection: React.FC = () => {
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
